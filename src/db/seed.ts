...
const rosters: Record<string, [string, number][]> = {
  'Cole': [
    ...
    ['James Wood', 694497],
    ['Jackson Merrill', 691621],
    ['Josh Naylor', 647304],
    ['Maikel Garcia', 672580],
    ['Tyler Soderstrom', 691159],
    ['Michael Harris II', 671739],
    ['Salvador Perez', 521692],
    ['Drake Baldwin', 694221],
    ['Ozzie Albies', 645277],
    ['Jacob Wilson', 694244],
  ],
  'Markus': [
    ...
    ['Hunter Goodman', 694260],
    ['Nico Hoerner', 663538],
    ['Trevor Story', 596115],
    ['Luke Keaschall', 700862],
    ['Jakob Marsee', 700679],
    ['Yanier Diaz', 673237],
  ],
  'J Mill': [
  ...
  'Ryan': [
    ...
    ['Konnor Griffin', 706185],
    ['Jung Hoo Lee', 808982],
    ['Jac Caglianone', 701044],
  ],
  'Joey': [
    ['Jose Ramirez', 608070],
    ['Kyle Tucker', 663656],
    ['Pete Crow-Armstrong', 691348],
  ...
  'Jack': [
    ...
    ['Junior Caminero', 692540],
    ['Ketel Marte', 606466],
    ['Trea Turner', 607208],
    ['Roman Anthony', 700244],
    ['Riley Greene', 682985],
    ['Randy Arozarena', 668227],
    ['Willy Adames', 642715],
    ['Lawrence Butler', 682619],
    ['Steven Kwan', 680757],
    ['Cedanne Rafaela', 678883],
    ['Luis Arraez', 650333],
    ['Heliot Ramos', 671218],
  ],
  'Austin': [
    ...
    ['Wyatt Langford', 700363],
    ['Bryce Harper', 547180],
    ['George Springer', 543807],
    ['Oneil Cruz', 665833],
    ['Corey Seager', 608369],
    ['Alex Bregman', 608324],
    ['Brenton Doyle', 686263],
    ['Jo Adell', 666176],
    ['Munetaka Murakami', 807986],
